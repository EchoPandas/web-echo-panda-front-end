...
const NavBar = () => {
  ...
  const LogoutConfirmModal = () =>
    _jsx("div", {
      ...
      children: _jsxs("div", {
        className:
          "bg-gray-900 text-white rounded-2xl p-8 w-96 text-center shadow-2xl",
        children: [
          _jsx("h2", {
          ...
          _jsx("p", {
            ...
            children: "Do you really want to log out from EchoPanda?",
          }),
          _jsxs("div", {
            ...
            children: [
              _jsx("button", {
                ...
                className:
                  "bg-red-600 hover:bg-red-700 px-5 py-2 rounded-full font-medium transition-all",
              ...
              _jsx("button", {
                ...
                className:
                  "bg-gray-600 hover:bg-gray-700 px-5 py-2 rounded-full font-medium transition-all",
                children: "Cancel",
              }),
            ],
          }),
    ...
    _jsx(
      "li",
      {
        ...
        children: _jsxs(NavLink, {
          ...
          children: [
            _jsx(link.icon, { className: "mr-4 h-5 w-5" }),
            link.label,
          ],
        }),
      },
      ...
      children: [
        Object.entries(groups).map(([key, group]) =>
          _jsxs(
            "div",
            {
              ...
              children: [
                _jsx("div", {
                  className: `${HEADER_CLASS} ${sidebarHeaderColor}`,
                  children: group.title,
                }),
                _jsx("ul", {
                  className: "mt-2 space-y-1",
                  children: group.links.map(renderLink),
                }),
              ],
            },
            key
        ...
        _jsx("div", {
          ...
          children: _jsxs("button", {
            ...
            className:
              "flex items-center text-sm font-semibold text-green-500 hover:text-green-400 transition-colors",
            children: [
              _jsx(FaPlus, { className: "mr-3 h-4 w-4" }),
              " Add Playlist",
            ],
          }),
        }),
          ...
          children: [
            _jsxs("div", {
              ...
              children: [
                _jsx("div", {
                  className:
                    "w-32 h-32 bg-blue-400 rounded-full animate-ping absolute opacity-50",
                }),
                _jsx("div", {
                  className:
  ...
  return _jsxs("div", {
    className: `flex h-screen ${mainBg} ${textColor}`,
    children: [
      isVoiceSearchOpen && _jsx(VoiceSearchModal, {}),
      showLogoutConfirm && _jsx(LogoutConfirmModal, {}),
      _jsxs("aside", {
        className: `w-72 flex flex-col transition-all ${sidebarBg}`,
        children: [
          _jsxs("div", {
            className: "p-8 flex items-center space-x-4",
            children: [
              _jsx("div", { className: "w-8 h-8" }),
              _jsxs("span", {
          ...
          _jsx("div", {
            ...
            children: _jsxs("button", {
              ...
              className:
                "flex items-center text-red-500 hover:text-red-400 text-lg",
              children: [
                _jsx(FaSignOutAlt, { className: "mr-3 h-5 w-5" }),
                " Logout",
              ],
            }),
          }),
      ...
      _jsxs("main", {
        ...
        children: [
            ...
            children: [
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("div", {
                    className:
                      "absolute right-3 top-2.5 text-gray-400 hover:text-blue-500 cursor-pointer",
                    onClick: () => {
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx(NavLink, {
                    to: "/login",
                    className:
                      "px-4 py-1 text-blue-500 hover:text-blue-400 font-medium",
                    children: "Login",
                  }),
                  _jsx(NavLink, {
                    to: "/register",
                    className:
                      "px-4 py-1 bg-blue-500 text-white rounded-full hover:bg-blue-600 font-medium",
                    children: "Sign Up",
                  }),
                ],
              }),
          ...
          _jsx("section", { className: "flex-1 overflow-auto p-6" }),
        ],
      }),
    ],
  });
