...
const NavBar = () => {
    ...
    const renderLink = (link) => (_jsx("li", { className: "px-4", children: _jsxs(NavLink, { to: link.path, className: ({ isActive }) => `flex items-center px-4 py-2 rounded-lg transition-all duration-200 ${isActive
                ...
                : `${linkTextColor} ${linkHoverBg}`}`, children: [_jsx(link.icon, { className: "mr-4 h-5 w-5" }), link.label] }) }, link.path));
    ...
    return (_jsxs("div", { className: `flex h-screen ${mainBg} ${textColor}`, children: [isVoiceSearchOpen && _jsx(VoiceSearchModal, {}), showLogoutConfirm && _jsx(LogoutConfirmModal, {}), _jsxs("aside", { className: `w-72 flex flex-col transition-all ${sidebarBg}`, children: [_jsxs("div", { className: "p-8 flex items-center space-x-4", children: [_jsx("div", { className: "w-8 h-8" }), _jsxs("span", { className: "text-2xl font-extrabold", children: [_jsx("span", { className: "text-fuchsia-600", children: "Echo" }), _jsx("span", { className: "text-blue-600", children: "Panda" })] })] }), _jsx("nav", { className: "flex-1 overflow-y-auto", children: renderSidebarGroups() }), _jsx("div", { className: `p-6 border-t ${isLightMode ? "border-gray-200" : "border-gray-800"}`, children: _jsxs("button", { onClick: () => {
                                setShowLogoutConfirm(true);
                                        ...
                                        }, placeholder: "Search for Music, Artists...", className: `w-full rounded-full py-2 px-4 pl-10 pr-10 focus:ring-2 focus:ring-blue-500 outline-none ${isLightMode
                                            ? "bg-gray-200 text-gray-900 placeholder-gray-500"
                                            : "bg-gray-900 text-white placeholder-gray-500"}` }), _jsx("div", { className: "absolute left-3 top-2.5 text-gray-400", children: _jsx("svg", { className: "h-5 w-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" }) }) }), _jsx("div", { className: "absolute right-3 top-2.5 text-gray-400 hover:text-blue-500 cursor-pointer", onClick: () => {
                                            setIsVoiceSearchOpen(true);
                                        }, children: _jsx(FaMicrophone, { className: "h-5 w-5" }) })] }), _jsxs("div", { className: "flex items-center space-x-6 ml-6", children: [_jsx(NavLink, { to: "/about-us", className: linkTextColor, children: "About Us" }), _jsx(NavLink, { to: "/contact-us", className: linkTextColor, children: "Contact" }), _jsx("button", { onClick: () => {
                                            setIsLightMode(!isLightMode);
                                        }, className: `${linkTextColor} p-2 rounded-full`, title: isLightMode ? "Switch to Dark Mode" : "Switch to Light Mode", children: isLightMode ? (_jsx(FaMoon, { className: "h-5 w-5" })) : (_jsx(FaSun, { className: "h-5 w-5 text-yellow-500" })) }), _jsx(NavLink, { to: "/login", className: "px-4 py-1 text-blue-500 hover:text-blue-400 font-medium", children: "Login" }), _jsx(NavLink, { to: "/register", className: "px-4 py-1 bg-blue-500 text-white rounded-full hover:bg-blue-600 font-medium", children: "Sign Up" })] })] }), _jsx("section", { className: "flex-1 overflow-auto p-6" })] })] }));
};
